...
const styles = {
  ...
  container: "2xl:container 2xl:mx-auto flex flex-col  lg:flex-row space-y-6 lg:space-y-0", 
  left: "w-full lg:w-6/12 h-full justify-start flex items-center  element-index",
  right: "w-full lg:w-6/12  h-full  element-index",
  leftContainer: "w-full h-full  element-index flex flex-col lg:mt-[84px] mb-[84px] lg:mb-0 ",
        ...
        <div className={styles.container}>
          <div className={styles.left}>
            <div className={styles.leftContainer}>
              <div className=" flex px-4 py-2 items-center space-x-4 border-[#f1f1f1] border-[1px] rounded-[26px] semibold font-semibold w-fit text-[10px] sm:text-base lg:text-lg">
              ...
              <div className="w-full sm:w-7/12 lg:w-9/12 mt-5">
                <div className="flex text-[24px] sm:text-3xl lg:text-[42px] flex-wrap leading-7 sm:leading-[40px] lg:leading-[51px] bold font-bold">
                ...
                <div className="text-white mt-4 ">
                  <p className="text-[16px] sm:text-xl lg:text-2xl leading-[25px] lg:leading-9 regular w-9/12">
