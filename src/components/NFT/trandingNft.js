...
const TrendingNFT = () => {
  return (
    <NormalLayout>
      <div className="trending-bg  p-2 md:p-20">
        <div className="w-full  ">
          <div className="w-full flex justify-between items-center mb-[32px] md:mb-[51px]">
            ...
            >
              <span className="text-sm md:text-lg">View More</span>
              <IoIosArrowForward className="text-lg" />
            </Link>
          </div>
          <div className="w-full md:min-h-[296px] h-full grid grid-cols-2 md:grid-cols-4 gap-[16px] md:gap-[32px]">
